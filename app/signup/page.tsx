...
export default function SignUpPage() {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      // TODO: integrar con tu backend de registro
      ...
      <div className="relative w-full max-w-[400px]">
        ...
        <div className="glass-panel border-primary/10 p-8 shadow-lg">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Regístrate como proveedor, negocio o inversionista.
          </p>
        ...
        <p className="mt-6 text-center text-xs text-muted-foreground">
          Al registrarte, aceptas los términos de uso y la política de privacidad de Faro.
        </p>
      </div>
    </div>
  )
